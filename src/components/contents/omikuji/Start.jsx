function Start({setCurrentScene}) {
  ...
  return (
    <div className="relative flex justify-center items-center">
      ...
      <button onClick={handleClick} style={{ top:"70%", fontSize:"25px", backgroundColor:"#D90000",width:"279px",height:"66px"}} className="absolute flex justify-center items-center text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline">
      おみくじを引く
