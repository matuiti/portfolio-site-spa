function Start({setCurrentScene}) {
  ...
  return (
    <div className="relative flex justify-center items-center">
      ...
      <button onClick={handleClick} style={{ top:"68%", fontSize:"1.4rem", backgroundColor:"#D90000",width:"88%",height:"10%"}} className="absolute flex justify-center items-center text-white font-bold rounded-full focus:outline-none focus:shadow-outline">
      おみくじを引く
